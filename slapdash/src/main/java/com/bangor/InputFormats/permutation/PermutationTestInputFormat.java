 ...
 * PermutationTestRecordReader instead of the default
 *
 * @author Joseph W Plant
 */
public class PermutationTestInputFormat extends TextInputFormat {

    @Override
    public RecordReader<LongWritable, Text> createRecordReader(
            InputSplit arg0, TaskAttemptContext arg1) {

        return new PermutationTestRecordReader();
    }
}
